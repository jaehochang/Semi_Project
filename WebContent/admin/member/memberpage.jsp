...
<div>
	...
	<div class="admin_member_gi">
		<table class="table table-condensed"
			style="margin: 50px auto; width: 700px;">
			<thead>
				<tr>
					<th style="font-size: 30px;">그룹 & 관심사</th>
				</tr>
			</thead>
			<tbody>
				<tr>
			...
			<tbody>
				...
				<tr>
					...
					<c:if test="${mdto.member_warningnumber == 0}">
						<td>
							<button id="block" type="button" class="btn btn-warning">정지</button>
						</td>
					</c:if>
					...
					<c:if test="${mdto.member_warningnumber == 2}">
						<td>
							<button id="delet" type="button" class="btn btn-danger"
								disabled>삭제중</button>
						</td>
					</c:if>
				</tr>
