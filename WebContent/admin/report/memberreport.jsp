...
<div style="margin: 150px auto; width: 1000px;">
	<ul class="nav nav-tabs">
		...
		<li role="presentation"><a href="meetupreport.ao">meetup신고</a></li>
	...
	<table class="table table-condensed"
		...
		<tbody>
			<c:forEach var="rdto" items="${list }">
				<tr>
					<td><a href="memberpage.ao?member_email=${rdto.report_calleemember }&state=0">${rdto.report_calleemember }</a></td>
					...
					<td class="badge" style="background-color: red">${rdto.report_state }</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
