...
<div style="margin: 150px auto; width: 1000px;">
	<ul class="nav nav-tabs">
		<li role="presentation"><a href="memberreport.ao?subject=report_calleemember&text=">회원신고</a></li>
		<li role="presentation" class="active"><a href="groupreport.ao?subject=report_calleegroup&text=">그룹신고</a></li>
	</ul>
