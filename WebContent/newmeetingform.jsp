      ...
      <div id="wrapper">
         ...
         <div id="wrapper-sub2">
            <div id="wrapper-sub2-title">
               ...
               <span style="padding-top: 10px;">대표사진</span>
               ...
               <div style="width: 600px; height: 200px;">
                  ...
                  <img src="img/default.jpg" style="width: 100%; height: 100%;"
                     id="meetimg"> <input type="hidden" id="meetingPic"
                     name="meetingPic" value="${systemName}">
               </div>
